...
export function MobileCta() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex gap-2 border-t border-ink/10 bg-cream/97 p-3 shadow-[0_-4px_20px_-8px_rgba(42,29,21,0.2)] backdrop-blur-sm lg:hidden">
      <a
